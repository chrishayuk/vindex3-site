...
const cases: Case[] = [
	...
	{ q: "what is conv-qkv attention?", expect: ["definition", "component_flow"], mustMention: "CONV-QKV" },
	{ q: "does attention need more than kv?", expect: ["canonical", "definition"] },
	{ q: "can an operator declare multiple state regions?", expect: ["canonical", "definition"] },
